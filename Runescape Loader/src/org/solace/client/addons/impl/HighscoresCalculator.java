package org.solace.client.addons.impl;
...
public class HighscoresCalculator extends JPanel { 
	...
	public AttributedString getSpecialString(String data) {
		...
		special.addAttribute(TextAttribute.FOREGROUND, Color.BLACK);
